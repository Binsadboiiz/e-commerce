                ...
                {hasItems ? (
                    <>
                        ...
                        <div className="bg-bg-card rounded-lg shadow-card px-5 py-3 mb-3
                            ...
                            <div className="flex-1 text-sm text-text-secondary font-medium">Sản Phẩm</div>
                            <div className="w-28 text-center text-sm text-text-secondary font-medium flex-shrink-0">Đơn Giá</div>
                            <div className="w-[88px] text-center text-sm text-text-secondary font-medium flex-shrink-0">Số Lượng</div>
                            <div className="w-28 text-right text-sm text-text-secondary font-medium flex-shrink-0">Thành Tiền</div>
